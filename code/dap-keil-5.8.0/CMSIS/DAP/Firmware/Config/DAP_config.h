...
#define CPU_CLOCK               192000000U      ///< Specifies the CPU Clock in Hz.
...
extern uint32_t DAP_DEFAULT_SWJ_CLOCK;//   6000000U        ///< Default SWD/JTAG clock frequency in Hz.

/// Maximum Package Size for Command and Response data.
/// This configuration settings is used to optimize the communication performance with the
/// debugger and depends on the USB peripheral. Typical vales are 64 for Full-speed USB HID or WinUSB,
/// 1024 for High-speed USB HID and 512 for High-speed USB WinUSB.
#define DAP_PACKET_SIZE         64u//512U            ///< Specifies Packet Size in bytes.
...
/// This information is returned by the command \ref DAP_Info as part of <b>Capabilities</b>.
#define SWO_UART                0//1               ///< SWO UART:  1 = available, 0 = not available.
...
#define TIMESTAMP_CLOCK         192000000U      ///< Timestamp clock in Hz (0 = timestamps not supported).

/// Indicate that UART Communication Port is available.
/// This information is returned by the command \ref DAP_Info as part of <b>Capabilities</b>.
#define DAP_UART                0//1               ///< DAP UART:  1 = available, 0 = not available.
...
__STATIC_INLINE void PORT_JTAG_SETUP (void) {
  ...
  PORT_Init(PORT_JTAG_TCK_SWCLK,PIN__JTAG_TCK_SWCLK,  &stcPortInit);
  PORT_Init(PORT_JTAG_TMS_SWDIO,PIN__JTAG_TMS_SWDIO,  &stcPortInit);

  PORT_SetFunc(PORT_JTAG_TCK_SWCLK,PIN__JTAG_TCK_SWCLK,Func_Gpio,Disable);
  PORT_SetFunc(PORT_JTAG_TMS_SWDIO,PIN__JTAG_TMS_SWDIO,Func_Gpio,Disable);
}
...
__STATIC_INLINE void PORT_OFF (void) {
  M4_PORT->PWPR = 0xA501u;//解锁IO寄存器
  M4_PORT->PCRB15_f.POUTE = 0;
  M4_PORT->PCRA8_f.POUTE = 0;
